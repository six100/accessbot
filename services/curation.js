...
module.exports = class Curation {
    ...
    switch (payload) {
      ...
      case "CURATION_SOMEONE_ELSE":
        response = Response.genQuickReply(i18n.__("curation.occasion"), [
          ...
          {
            title: i18n.__("curation.interview"),
            payload: "CURATION_OCASION_INTERVIEW"
          },
          {
      ...
      case "CURATION_OCASION_INTERVIEW":
        // Store the user budget preference here
        response = Response.genQuickReply(i18n.__("curation.price"), [
          {
            title: "~ $20",
            payload: "CURATION_BUDGET_20_INTERVIEW"
          },
          {
            title: "~ $30",
            payload: "CURATION_BUDGET_30_INTERVIEW"
          },
          {
            title: "+ $50",
            payload: "CURATION_BUDGET_50_INTERVIEW"
          }
        ]);
        break;
      ...
      case "CURATION_BUDGET_20_INTERVIEW":
      case "CURATION_BUDGET_30_INTERVIEW":
      case "CURATION_BUDGET_50_INTERVIEW":
  ...
  randomOutfit() {
    let occasion = ["work", "interview", "dinner"];
